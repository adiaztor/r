...
Se usa si los datos son muy grandes y si tienen una distribución sesgada positiva
Si los valores grandes están en el estudio la varianza será más constante y los datos se normalizarán
...
conjunto de datos a través de cuartiles y así ver mejor la media, los cuartiles y valores atípicos
...
# Primero separamos las dos condiciones. ¿Qué tipo de datos has generado? una matriz (tabla)
wt <- data [,1:3]
> ko <-data[,4:6]
> class (wt)
...
Nos sirve para poder ver mejor los datos
